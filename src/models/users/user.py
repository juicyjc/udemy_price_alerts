...
class User(object):
    ...
    def register_user(email, password):
        ...
        :param email: The user's email (might be invalide)
        :param password: A sha512 hashed password
        :return: True if registerd successfully, False otherwise (excecptions can also be raise)
        """
        ...
        if not Utils.email_is_valid(email):
            # Tell the use that their e-mail is not constructed properly.
